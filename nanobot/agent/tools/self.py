...
class MyTool(Tool):
    ...
    READ_ONLY = frozenset({
        ...
        "bash_config",  # inspect allowed (e.g. check sandbox), modify blocked
    ...
    def description(self) -> str:
        base = (
            ...
            "Note: web_config and bash_config are readable but read-only.\n"
            "\n"
            "When to use:\n"
    ...
    def _inspect_all(self) -> str:
        ...
        for k in ("workspace", "provider_retry_mode", "max_tool_result_chars", "_current_iteration", "web_config", "bash_config", "subagents"):

...
class FeishuChannel(BaseChannel):
    ...
    async def _add_reaction(self, message_id: str, emoji_type: str = "THUMBSUP") -> str | None:
        ...
        is stored in ``_active_reactions`` for later cleanup by ``send_delta``.
    ...
    def _on_reaction_added(self, chat_id: str, message_id: str, task: asyncio.Task) -> None:
    ...
    async def _on_message(self, data: P2ImMessageReceiveV1) -> None:
        ...
        try:
            ...
            task.add_done_callback(lambda t, cid=reply_to: self._on_reaction_added(cid, message_id, t))
